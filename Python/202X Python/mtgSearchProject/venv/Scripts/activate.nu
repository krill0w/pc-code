...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\dom\Documents\Coding\pc-code\Python\202X Python\mtgSearchProject\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\dom\Documents\Coding\pc-code\Python\202X Python\mtgSearchProject\venv\Scripts\deactivate.nu'
